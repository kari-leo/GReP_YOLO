...
def process_images(color_image, depth_image, pc_helper):
    ...
    ori_rgb = np.array(color_image) / 255.0
...
class ImageSubscriberNode:
    def __init__(self):
        ...
        # 定义订阅者
        self.depth_sub = rospy.Subscriber('/depth_img', Image, self.depth_callback)
        self.rgb_sub = rospy.Subscriber('/rgb_img', Image, self.rgb_callback)
